...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            preprocessin_obj=self.get_data_transformer_object()
            ...
            input_feature_train_arr=preprocessin_obj.fit_transform(input_feature_train_df)
            input_feature_test_arr=preprocessin_obj.transform(input_feature_test_df)
